					...
					<div class="row">
						<div class="col-md-12">
							<div class="collapse" id="fm_filter">
								<div class="card">
									<div class="card-body">
										<form method="post" action="<?= site_url('admin/outlet/search') ?>">
											<div class="form-row">
											...
											<?php foreach ($data as $key => $val) : ?>
												<tr>
													...
													<td class="text-center">
														<a href="void:javascript()" class="btn btn-xs btn-outline-success" title="Sunting" onclick="sunting('<?= $val['kd_cabang'] ?>')">
															<i class="fas fa-fw fa-edit"></i>
														</a>
														<a href="void:javascript()" class="btn btn-xs btn-outline-danger" title="Hapus" onclick="hapus('<?= $val['kd_cabang'] ?>')">
